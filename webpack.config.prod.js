...
const API_ROOT = 'https://oacw5pf0gi.execute-api.eu-north-1.amazonaws.com'; // CHANGE THIS TO MATCH THE URL OF YOUR API GATEWAY API OR YOUR CUSTOM DOMAIN FOR API
